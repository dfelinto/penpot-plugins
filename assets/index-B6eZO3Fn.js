(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function e(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=e(n);fetch(n.href,a)}})();const t=`<h1 class="display">Plugin styles</h1>
<main>
...
`,i=class i extends HTMLElement{connectedCallback(){this.innerHTML=t,Array.from(this.querySelectorAll("template")).forEach(l=>{var a;const e=document.createElement("pre"),s=document.createElement("code");s.classList.add("language-html");const n=l.innerHTML.replaceAll(this.getIndentationSize(l.innerHTML),"");s.textContent=n,e.appendChild(s),(a=l.parentNode)==null||a.appendChild(e),l.remove()}),window.hljs.highlightAll()}getIndentationSize(l){const e=l.length-l.trimStart().length;return" ".repeat(e-1)}};i.observedAttributes=[];let c=i;customElements.define("app-root",c);
